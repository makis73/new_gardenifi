...
import 'package:new_gardenifi_app/src/features/bluetooth/presentation/connect_device_screen.dart';
...
class _BluetoothConnectinScreenState extends ConsumerState<FindDeviceScreen> {
                      ...
                      : Expanded(
                          child: Column(
                            ...
                            children: [
                              Flexible(
                                flex: 2,
                                child: buildScanResultWidget(scanResultState) ?? Container(),
                              ),
                              if (!deviceConnected)
        ...
        data: (device) {
          if (device != null) {
            ...
            Navigator.of(context).push(MaterialPageRoute(
              builder: (context) => ConnectDeviceScreen(raspiDevice),
            ));
